...
1. Ask what formats they need (or default to all of: LinkedIn post, X/Twitter thread, email newsletter, Instagram caption)
2. Generate each format from the original content
3. Humanize each format with Walter in light mode (repurposed content should feel casual and native to each platform)
4. Run detection on each
