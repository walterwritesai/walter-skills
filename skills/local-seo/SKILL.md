...
1. Each piece of content must be unique. Do not just swap city names in a template. Include local context, neighborhoods, landmarks, or area-specific details that make each page distinct.
2. Preserve location keywords exactly: "[service] in [city]" should appear in the H1 concept, first paragraph, and closing paragraph.
3. Humanize all content through Walter in balanced mode.
4. Run detection on each piece.
